...
const ReviewBox: React.FC<ReviewBoxProps> = ({
  ...
  return (
    <div className="px-4 py-[18px] shadow-md shadow-secondary-orange-100/10 text-primary-black-90 md:px-[46px] md:py-7 rounded-[10px] border border-secondary-orange-100/10s grid gap-y-[14px] md:gap-y-6">
